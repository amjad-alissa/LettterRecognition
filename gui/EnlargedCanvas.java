...
//Canvas area for showing and drawing the letters
public class EnlargedCanvas extends Canvas {
    ...
    //Read the canvas into an array of double[256]
    public static double [] readPixels() {

        //For capturing the current state of the canvas, in order to read it into the array
        ...
        for (int x = 0; x < CANVASWIDTH; x += RECWIDTH + gap) {
            for (int y = 0; y < CANVASHEIGHT; y += RECHEIGHT + gap) {
                ...
                //Don't know why this exact value though
